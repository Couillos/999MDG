...
void Plotter::equity_chart() {
    ...
    std::string const out = dir_ + "/equity_chart.png";
...
void Plotter::exposure_chart() {
    ...
    std::string const out = dir_ + "/exposure_chart.png";
...
void Plotter::pnl_per_symbol_chart() {
    ...
    std::string const out = dir_ + "/pnl_per_symbol.png";
