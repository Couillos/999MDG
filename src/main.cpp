...
static void write_analysis_json(const std::string& path, const Metrics& m,
    ...
    std::fprintf(f, "      \"entry_condition\": {\n");
    std::fprintf(f, "        \"%s\": {\n", cfg.strategy.entry_condition_type.c_str());
    ...
    std::fprintf(f, "        }\n");
    std::fprintf(f, "      },\n");
    std::fprintf(f, "      \"closes_algo\": {\n");
    std::fprintf(f, "        \"%s\": {\n", cfg.strategy.closes_algo_type.c_str());
